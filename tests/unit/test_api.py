...
def mock_registry():
    ...
    r.model_version = "1"
    r.info = {"model_name": "test-model", "model_version": "1", "model_uri": None, "is_loaded": True, "backend": "huggingface"}
    r.predict.return_value = [{"text": "great", "label": "positive", "score": 0.95, "model_version": "1"}]
    return r
...
def test_drift_no_drift(client):
